...
<div class="card wide">
<?php if (!$evals): ?>
    <p style="color:var(--muted);font-size:13px;">No assessment yet. One runs when you apply
       for a credit-linked product.</p>
    <a class="btn" style="margin-top:16px;" href="<?= CUST_BASE ?>/dashboard/offers.php">See what is available</a>
<?php else: ?>
    <table class="table">
        <thead><tr><th scope="col">#</th><th scope="col">Date</th><th scope="col">Score</th>
        <th scope="col">Band</th><th scope="col">Limit</th><th scope="col">Decision</th></tr></thead>
        <tbody>
